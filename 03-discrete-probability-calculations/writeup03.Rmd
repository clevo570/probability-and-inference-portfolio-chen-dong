...
The second one is Braves win in 7 or less games.
```{r}
p1 <- pbinom(3,7,0.55,lower.tail = FALSE)
p2 <- pbinom(3,7,0.45,lower.tail = FALSE)

p <- 0.5 * p1 / (0.5 * p1 + 0.5 *p2)
p
```
P(PB = 0.55|Braves win World Series in 7 games) is 0.6082878, which is shown above.(7 or less games)
