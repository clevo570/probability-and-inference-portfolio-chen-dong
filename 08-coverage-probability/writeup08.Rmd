...
We set the sample size to 201 and simulated the normal distribution. According to the theorem of sample distribution, after using MLE, we can plot its distribution(hist) and theoretical distribution(curve).
